...
router.post('/', authenticate, authorize(['Gerente', 'Administracion']), ensureUser, clientesController.create);
...
router.post('/:id', authenticate, authorize(['Gerente', 'Administracion']), ensureUser, clientesController.update);
